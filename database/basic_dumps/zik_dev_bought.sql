...
CREATE TABLE `bought` (
  ...
  KEY `FK_Association_11` (`price_id`),
  CONSTRAINT `FK_Association_11` FOREIGN KEY (`price_id`) REFERENCES `price_tag` (`id`),
  CONSTRAINT `FK_Association_7` FOREIGN KEY (`track_id`) REFERENCES `track` (`id`),
  CONSTRAINT `FK_Association_8` FOREIGN KEY (`user_buying_id`) REFERENCES `user` (`id`)
...
INSERT INTO `bought` VALUES (1,1,1,1,'2018-08-31 00:00:00');
